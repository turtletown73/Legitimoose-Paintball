...
execute if score time timeTicks matches ..0 if score game roundRunning matches 0 unless score playerCount teamKills matches 2.. run scoreboard players set time timeTicks 600
...
execute store result score Time teamDeathmatchDisplay run scoreboard players get time teamKills
