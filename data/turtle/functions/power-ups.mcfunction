...
execute as @a[tag=DoubleJumped] at @s if predicate turtle:crouching if score @s powerup matches 7 if entity @s[nbt={OnGround:1b}] run tag @s remove DoubleJumped